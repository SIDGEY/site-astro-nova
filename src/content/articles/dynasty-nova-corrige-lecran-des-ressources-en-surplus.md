...
## Un empire ne devrait jamais perdre ses ressources

Gérer un empire spatial, c'est avant tout gérer un flux : métal, cristal et hydrogène s'accumulent, se dépensent, s'échangent entre planètes. Mais un bug récent cassait ce flux dans un cas précis — et particulièrement injuste — celui du surplus.
